...
class TestQueuedCollectionRich(AbstractResponseTest):
    ...
    def test_demo_command_first_function_value(self, kernel, capsys) -> None:
    ...
    def test_nested_collection_previous_value(self, kernel) -> None:
        received = []
        ...
        def after_sub(previous_value) -> str:
