...
class TestYamlRunner(AbstractKernelTest):
    def test_env_var_injected(self, kernel) -> None:
    ...
    def test_ignore_error_step(self, kernel) -> None:
    ...
    def test_option_overrides_env(self, kernel) -> None:
    ...
    def test_python_runner_error_raised_at_render(self, kernel) -> None:
    ...
    def test_python_runner_ignore_error(self, kernel) -> None:
    ...
    def test_python_runner_returns_lazy_response(self, kernel) -> None:
    ...
    def test_step_options_contract(self, kernel) -> None:
    ...
    def test_unknown_step_option_raises(self, kernel) -> None:
...
"""
        ...
        try:
            ...
            from wexample_wex_core.yaml.yaml_command_definition import (
                YamlCommandDefinition,
            )
    ...
    def test_workdir_step(self, kernel) -> None:
    ...
    def test_workdir_substitution(self, kernel) -> None:
    ...
    def test_yaml_command_executes_default(self, kernel) -> None:
    ...
    def test_yaml_command_executes_with_name(self, kernel) -> None:
        from wexample_app.response.interactive_shell_command_response import (
            InteractiveShellCommandResponse,
        )
    ...
    def test_yaml_command_has_description(self, kernel) -> None:
        addon_commands = kernel.get_configuration_registry().get_addon_commands()
        cmd = addon_commands["demo"]["yaml/hello"]
        assert (
            cmd.get("description")
            == "Demo YAML command — prints a greeting using a bash script"
        )

    def test_yaml_command_in_registry(self, kernel) -> None:
        addon_commands = kernel.get_configuration_registry().get_addon_commands()
